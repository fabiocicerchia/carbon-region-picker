...
[![CI carbon](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/fabiocicerchia/carbon-region-picker/gh-pages/badge.json)](.github/workflows/carbon-badge.yml)
...
```sh
cosign verify ghcr.io/fabiocicerchia/carbon-region-picker:latest \
  --certificate-identity-regexp \
    'https://github.com/fabiocicerchia/carbon-region-picker/.github/workflows/.*' \
